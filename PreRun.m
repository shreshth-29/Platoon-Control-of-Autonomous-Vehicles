...
v0_lead = 25/9;   % initial velocity for lead car (m/s)
...
amin_ego = -3;
amax_ego = 2;
v0_ego_1 = 20/9;   % initial velocity for ego car (m/s)
v0_ego_2 = 20/9;   % initial velocity for ego car (m/s)
v0_ego_3 = 20/9;   % initial velocity for ego car (m/s)
